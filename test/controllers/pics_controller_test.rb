...
class PicsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pic" do
    assert_difference('Pic.count') do
      post pics_url, params: { pic: { img_url: @pic.img_url, space_id: @pic.space_id } }, as: :json
    end
  ...
  test "should update pic" do
    patch pic_url(@pic), params: { pic: { img_url: @pic.img_url, space_id: @pic.space_id } }, as: :json
    assert_response 200
  end
